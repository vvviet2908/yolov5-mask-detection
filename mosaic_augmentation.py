...
def main():
    ...
    for index in tqdm(range(NUMBER_IMAGES)):
        ...
        cv2.imwrite("imgs_augment/samples/images/{}_{}_{}.jpg".format(file_name, TYPE_TRANSFORM,
        ...
        with open("imgs_augment/samples/labels/{}_{}_{}.txt".format(file_name, TYPE_TRANSFORM, letter_code), "w") as outfile:
